...
namespace Cheat
{
    ...
    extern bool OverheatRifleNoHeat;   // Zero overheat rifle heat
    extern bool UnlimitedTorchDuration;// Freeze torch durability
    extern bool InstantWorkProgress;   // Instant work via debug setting
    extern bool InstantAcceleration;   // Max acceleration for movement
    extern int RewindHours;            // Rewind time by N hours (one-shot)
