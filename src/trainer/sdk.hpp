...
public:
    ...
    float* GetDropItemRate()                       { return (float*)((uint8_t*)this + 0x060); }
    float* GetExpRate()                            { return (float*)((uint8_t*)this + 0x064); }
};
...
public:
    ...
    bool* GetbIsInstantFishing()        { return (bool*)((uint8_t*)this + 0x1B4); }
    bool* GetbIsInstantWorkProgress()   { return (bool*)((uint8_t*)this + 0x1B5); }
    float* GetFishSpeedRate()           { return (float*)((uint8_t*)this + 0x1B8); }
    bool* GetbIsDisableHeatOverload()   { return (bool*)((uint8_t*)this + 0x1BC); }
};
...
public:
    ...
    float* GetHeatValue()             { return (float*)((uint8_t*)this + 0x518); }
    float* GetMaxHeatValue()          { return (float*)((uint8_t*)this + 0x51C); }
};
